...
class LSTM_MAEPlugin:
 ...
 def output(self, outputfile):
  ...
  mc = ModelCheckpoint(PyPluMA.prefix()+"/saved_model/lstm.h5", monitor='val_mae', mode='min', verbose=2, save_best_only=True)
  ...
  model_load = load_model(PyPluMA.prefix()+"/saved_model/lstm.h5")
  ...
  inv_y.to_csv(outputfile+"/inv_y_lstm.csv")
  inv_yhat.to_csv(outputfile+"/inv_yhat_lstm.csv")
  error.to_csv(outputfile+"/error_lstm.csv")
